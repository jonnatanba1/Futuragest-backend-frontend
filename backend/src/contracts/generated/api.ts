...
export interface paths {
    ...
    "/compensacion/{operarioId}": {
        ...
        get: operations["CompensacionController_getPeriodBalance"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/jornada-policy": {
        ...
        get: operations["CompensacionController_getJornadaPolicyTimeline"];
        put?: never;
        post: operations["CompensacionController_setJornadaPolicy"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/compensacion/{operarioId}/close": {
        ...
        get?: never;
        put?: never;
        post: operations["CompensacionController_closeFortnight"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/compensacion/{operarioId}/payout": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["CompensacionController_getPeriodPayout"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/compensacion/{operarioId}/payout/confirm": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        post: operations["CompensacionController_confirmPeriodPayout"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        OperarioResponseDto: {
            ...
            /** Format: uuid */
            supervisorId: string;
            /** @description Free-text job position (e.g. "Barrido", "Recolección") */
            cargo: string;
        ...
        DayBreakdownDto: {
            /** @description YYYY-MM-DD Colombia local date */
            date: string;
            /**
             * @description Raw hours worked (no lunch deduction). Decimal string.
             * @example 8.50
             */
            horasReales: string;
            /**
             * @description JornadaPolicy hours for this day. Decimal string.
             * @example 8.00
             */
            jornadaHoras: string;
            /**
             * @description horasReales - jornadaHoras. Decimal string.
             * @example 0.50
             */
            delta: string;
        };
        PeriodBalanceResponseDto: {
            ...
            hasta: string;
            /**
             * @description Σ positive deltas (hours). Decimal string.
             * @example 0.75
             */
            creditosHoras: string;
            /**
             * @description Σ |negative deltas| (hours). Decimal string.
             * @example 1.00
             */
            debitosHoras: string;
            /**
             * @description carryIn from previous CARRY_OVER period (≤ 0). Decimal string.
             * @example 0.00
             */
            carryIn: string;
            /**
             * @description carryIn + creditos - debitos. Decimal string.
             * @example -0.25
             */
            saldoHoras: string;
            breakdown: components["schemas"]["DayBreakdownDto"][];
        };
        SetJornadaPolicyBody: {
            /**
             * @description Daily work hours [0.5, 24]
             * @example 8
             */
            horasDiarias: number;
            /**
             * @description Effective date — YYYY-MM-DD Colombia local
             * @example 2026-07-01
             */
            vigenteDesde: string;
        };
        JornadaPolicyResponseDto: {
            ...
            id: string;
            /**
             * @description Daily work hours. Prisma Decimal serialized as string.
             * @example 8.00
             */
            horasDiarias: string;
            /** @description ISO 8601 — effective date (Colombia local midnight stored as UTC) */
            vigenteDesde: string;
            /** @description ISO 8601 timestamp */
            createdAt: string;
        };
        CloseFortnightBody: {
            /**
             * @description Fortnight start — YYYY-MM-DD Colombia local (inclusive)
             * @example 2026-05-01
             */
            desde: string;
            /**
             * @description Fortnight end — YYYY-MM-DD Colombia local (inclusive)
             * @example 2026-05-15
             */
            hasta: string;
            /**
             ...
             * @enum {string}
             */
            disposition?: "CARRY_OVER" | "PAYROLL_DEDUCTION";
            /** @description Optional client idempotency token */
            clientRef?: Record<string, never>;
        };
        CompensationPeriodResponseDto: {
            ...
            /** Format: uuid */
            operarioId: string;
            /** @description Canonical fortnight identifier e.g. "2026-05-Q1" */
            periodKey: string;
            /** @description YYYY-MM-DD Colombia local (inclusive) */
            desde: string;
            /** @description YYYY-MM-DD Colombia local (inclusive) */
            hasta: string;
            /**
            ...
            /** @description ISO 8601 timestamp — when the close decision was made */
            decidedAt: Record<string, never> | null;
            /** @description ISO 8601 timestamp — immutability lock (server time at close) */
            closedAt: string;
            /** @description Client-provided idempotency token */
            clientRef: Record<string, never> | null;
            /** @description ISO 8601 timestamp — when payout was confirmed by HR. Null until confirmed. */
            paidAt: Record<string, never> | null;
            /** @description Server-generated UUID for payout idempotency. Null until confirmed. */
            payoutRef: Record<string, never> | null;
            /** @description ISO 8601 timestamp — set when attendance data changes inside this closed period. Null = snapshot is current. */
            divergedAt: Record<string, never> | null;
            /** @description ISO 8601 timestamp */
            createdAt: string;
        };
        PeriodPayoutResponseDto: {
            ...
            periodKey: string;
            /**
             * @description Frozen saldo of the closed period (can be ≤ 0). Decimal string.
             * @example 8.00
             */
            saldoHoras: string;
            /**
             * @description Payable base hours (positive saldo only; 0 if saldo ≤ 0). Decimal string.
             * @example 8.00
             */
            horasBase: string;
            /**
             * @description Recargo factor applied (1.25 daytime). Decimal string.
             * @example 1.25
             */
            factorRecargo: string;
            /**
             * @description horasBase × factorRecargo — payable hours to liquidate. Decimal string.
             * @example 10.00
             */
        ...
        NovedadResponseDto: {
            ...
            decidedAt: Record<string, never> | null;
            /**
             * @description Audit label: verification method used by the líder operativo when deciding. Null = web admin decision (no biometrics) or legacy row.
             * @enum {string|null}
             */
...
export interface operations {
    ...
    CompensacionController_getPeriodBalance: {
        parameters: {
            query: {
                desde: string;
                hasta: string;
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PeriodBalanceResponseDto"];
                };
            };
        };
    };
    CompensacionController_getJornadaPolicyTimeline: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["JornadaPolicyResponseDto"][];
                };
            };
        };
    };
    CompensacionController_setJornadaPolicy: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SetJornadaPolicyBody"];
            };
        };
        responses: {
            201: {
    ...
    CompensacionController_closeFortnight: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CloseFortnightBody"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CompensationPeriodResponseDto"];
                };
            };
            201: {
                headers: {
    ...
    CompensacionController_getPeriodPayout: {
        parameters: {
            query: {
                periodKey: string;
            };
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PeriodPayoutResponseDto"];
                };
            };
        };
    };
    CompensacionController_confirmPeriodPayout: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ConfirmPayoutBody"];
            };
        };
        responses: {
            200: {
    ...
    NovedadController_approveNovedad: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ApproveRejectBody"];
            };
        };
        responses: {
            200: {
